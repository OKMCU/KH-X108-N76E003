...
#ifndef __APP_TASKSCHED_H__
#define __APP_TASKSCHED_H__

#include "..\bsp\stdint.h"
#include "firmware_conf.h"

#if APP_TASKSCHED_EN > 0
extern void    appTaskSchedSrvStart (void);
extern void    appTaskSchedSystickCb(void);
extern void    appTaskSchedSrv      (void);
extern int8_t  appTaskSchedCreate   (uint32_t time, void (*task)(void));
